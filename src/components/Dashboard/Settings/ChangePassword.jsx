      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        <div>
          ...
          <div className="relative">
            ...
            >
              {showCurrentPassword ? <IoEyeOff className="text-gray-400" /> : <IoEye className="text-gray-400" />}
            </button>
          </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute top-1/2 right-3 transform -translate-y-1/2 bg-transparent border-none"
            >
              {showNewPassword ? <IoEyeOff className="text-gray-400" /> : <IoEye className="text-gray-400" />}
            </button>
          </div>
          {errors.newPassword && <span className="text-sm text-red-500">This field is required</span>}
        </div>
        <button type="submit" className="bg-theme text-white rounded-lg py-2 px-4 font-semibold transition duration-300 hover:bg-blue-600">Submit</button>
      </form>
    </div>
  );
};
